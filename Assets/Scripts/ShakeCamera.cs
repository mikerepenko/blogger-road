        ...
        if (elapsed < i_Duration)
        {
            ...
            switch (i_Mode)
            {
                ...
                case ShakeMode.OnlyX:
                    tr.localPosition = originalPos + new Vector3(rnd.x, 0, 0) * Time.deltaTime;
                    break;
                case ShakeMode.OnlyY:
                    tr.localPosition = originalPos + new Vector3(0, rnd.y, 0) * Time.deltaTime;
                    break;
                case ShakeMode.OnlyZ:
                    tr.localPosition = originalPos + new Vector3(0, 0, rnd.z) * Time.deltaTime;
                    break;
                case ShakeMode.XY:
                    tr.localPosition = originalPos + new Vector3(rnd.x, rnd.y, 0) * Time.deltaTime;
                    break;
                case ShakeMode.XZ:
                    tr.localPosition = originalPos + new Vector3(rnd.x, 0, rnd.z) * Time.deltaTime;
                    break;
            }
        }
    }
